...
<body>
      ...
      <div id="ctrl-tie" class="ctrl-panel">
        <div id="ctrl-tie-range" class="obd-dual-single-mode">
          <div id="tie-dual-range" class="obd-dual-slider" aria-label="Tie point index">
            ...
            <input type="range" id="tie-range-low" min="0" max="{tm}" step="1" value="0" aria-label="Minimum tie point index">
            <input type="range" id="tie-range-high" min="0" max="{tm}" step="1" value="0" aria-label="Maximum tie point index">
          </div>
          ...
          <input type="number" id="tie-num-high" class="range-num" min="0" max="{tm}" step="1" value="0" aria-label="Tie maximum index" disabled>
        </div>
      </div>
  ...
  <script>
    ...
    function colorForTieIdx(tIdx, tLo, tHi) {{
      ...
      var hi = tHi !== undefined ? tHi : TIE_IDX_MAX;
      var span = hi - lo;
      var tt = span > 0 ? (tIdx - lo) / span : 0;
      return "hsl(" + Math.round(240 * (1 - tt)) + ", 70%, 45%)";
    }}
